...
System.register([], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      !function () {
        function t(i) {
          if (!(this instanceof t)) return new t(i);this._canvas = i = "string" == typeof i ? document.getElementById(i) : i, this._ctx = i.getContext("2d"), this._width = i.width, this._height = i.height, this._max = 1, this.clear();
            ...
            for (var a, s = 3, e = t.length; s < e; s += 4) {
              (a = 4 * t[s]) && (t[s - 3] = i[a], t[s - 2] = i[a + 1], t[s - 1] = i[a + 2]);
            }
          } }, window.simpleheat = t;
          ...
          return this._heat && !this._frame && this._map && !this._map._animating && (this._frame = L.Util.requestAnimFrame(this._redraw, this)), this;
          ...
          if (this._map) {
            var t,
                ...
                w = v.x % p,
                y = v.y % p;for (t = 0, i = this._latlngs.length; t < i; t++) {
              if (a = this._map.latLngToContainerPoint(this._latlngs[t]), m.contains(a)) {
                e = Math.floor((a.x - w) / p) + 2, n = Math.floor((a.y - y) / p) + 2;var x = void 0 !== this._latlngs[t].alt ? this._latlngs[t].alt : void 0 !== this._latlngs[t][2] ? +this._latlngs[t][2] : 1;r = x * f, g[n] = g[n] || [], s = g[n][e], s ? (s[0] = (s[0] * s[2] + a.x * r) / (s[2] + r), s[1] = (s[1] * s[2] + a.y * r) / (s[2] + r), s[2] += r) : g[n][e] = [a.x, a.y, r];
              }
            }for (t = 0, i = g.length; t < i; t++) {
              if (g[t]) for (h = 0, o = g[t].length; h < o; h++) {
                (s = g[t][h]) && _.push([Math.round(s[0]), Math.round(s[1]), Math.min(s[2], c)]);
              }
